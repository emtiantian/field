...
(function(factory) {
	...
	$.extend(Plugin.prototype, {
		...
		content: function() {
			...
			if (obj.settings.ajaxContentUrl) {
				...
				if (obj.settings.contentElementId) {
	...
	function reposition(thisthat) {
		...
		case "top-right":
			...
			tipso_bubble.find(".tipso_arrow").css({
				marginLeft: -obj.settings.width / 2,
				marginTop: "",
			});
			if (pos_top < $win.scrollTop()) {
				pos_top = $e.offset().top + $e.outerHeight() + arrow;
				if (pos_left + obj.settings.width + realHeight(tipso_bubble).width > $win.outerWidth()) {
					
					offsetObj ={"x":  -realHeight(tipso_bubble).width  ,"y": realHeight(tipso_bubble).height + arrow}
					console.dir(offsetObj);
					console.log("右下");
					tipso_bubble.find(".tipso_arrow").css({
						marginLeft: obj.settings.width / 2 - 2 * obj.settings.arrowWidth,
						marginTop: "",
					});
					pos_left = $e.offset().left - realHeight(tipso_bubble).width - obj.settings.offsetX;
					tipso_bubble.find(".tipso_arrow").css({
					...
					offsetObj ={"x": arrow ,"y": realHeight(tipso_bubble).height + arrow}
					console.dir(offsetObj);
					console.log("左下");
					tipso_bubble.find(".tipso_arrow").css({
						"border-bottom-color": arrow_color,
				...
				if (pos_left + obj.settings.width + realHeight(tipso_bubble).width > $win.outerWidth()) {
					...
					offsetObj ={"x": -realHeight(tipso_bubble).width,"y": -arrow -offsetMouse}
					console.dir(offsetObj);
					console.log("左上");
					tipso_bubble.find(".tipso_arrow").css({
					...
					offsetObj ={"x": 2,"y": -arrow-offsetMouse}
					console.dir(offsetObj);
					console.log("右上");
					tipso_bubble.find(".tipso_arrow").css({
						"border-top-color": obj.settings.background,
